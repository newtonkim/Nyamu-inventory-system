...
import { _ as _sfc_main$2 } from "./GuestLayout-C0ItcYc_.js";
      ...
      _push(ssrRenderComponent(_sfc_main$2, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="mt-6"${_scopeId}><div class="relative"${_scopeId}><div class="absolute inset-0 flex items-center"${_scopeId}><div class="w-full border-t border-gray-300"${_scopeId}></div></div><div class="relative flex justify-center text-sm"${_scopeId}><span class="px-2 bg-white text-gray-500"${_scopeId}>Or continue with</span></div></div><div class="mt-6"${_scopeId}><a${ssrRenderAttr("href", _ctx.route("google.redirect"))} class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50"${_scopeId}><svg class="w-5 h-5" viewBox="0 0 24 24"${_scopeId}><path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"${_scopeId}></path><path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"${_scopeId}></path><path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"${_scopeId}></path><path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z"${_scopeId}></path></svg><span class="ml-2"${_scopeId}>Sign in with Google</span></a></div></div></form>`);
          } else {
            return [
                ...
                createVNode("div", { class: "mt-6" }, [
                  createVNode("div", { class: "relative" }, [
                    ...
                    createVNode("div", { class: "relative flex justify-center text-sm" }, [
                      createVNode("span", { class: "px-2 bg-white text-gray-500" }, "Or continue with")
                    ])
                  ]),
                  createVNode("div", { class: "mt-6" }, [
                    createVNode("a", {
                      ...
                      createVNode("span", { class: "ml-2" }, "Sign in with Google")
                    ], 8, ["href"])
                  ])
                ])
              ], 32)
